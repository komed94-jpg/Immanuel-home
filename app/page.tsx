...
import {
  ArrowRight, BookOpen, Church, Flame, HandHeart, Home, Leaf, Menu,
  MessageCircleHeart, Send, Sparkles, Sprout, UserRound
} from "lucide-react";
    ...
    <div className="page">
      <section className="desktopGrid">
        <div className="hero">
          ...
          <div className="heroBottom">
            ...
            <div className="heroActions">
              <button className="primaryBtn">비전 보기 <ArrowRight size={17} /></button>
              <button className="ghostBtn">오늘의 말씀</button>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <article className="bigCard">
            <h3>요한일서 4:8</h3>
            <p>“하나님은 사랑이심이라.” 사랑은 우리의 출발점이며, 임마누엘의 삶은 그 사랑 안에서 시작됩니다.</p>
          </article>
      ...
      <section className="coreGrid">
        {core.map((item) => {
          ...
          return (
            <article className="coreCard" key={item.title}>
      ...
      <div className="sectionTitle"><h2>교회의 고백</h2><span>Declaration</span></div>
      <section>
...
function WordPage() {
  return (
    <div className="page">
      <div className="sectionTitle"><h2>말씀</h2><span>Word</span></div>
      <article className="bigCard">
...
function PrayerPage() {
  return (
    <div className="page">
      <div className="sectionTitle"><h2>기도</h2><span>Prayer</span></div>
      <article className="bigCard">
...
function GrowthPage() {
  return (
    <div className="page">
      <div className="sectionTitle"><h2>성장</h2><span>Growth</span></div>
      <article className="bigCard">
      ...
      <article className="rowCard"><div className="rowIcon"><Flame size={24} /></div><div><h3>매일의 습관</h3><p>말씀, 기도, 감사, 섬김의 작은 순종을 기록합니다.</p></div></article>
    </div>
  );
}
...
function MyPage() {
  return (
    <div className="page">
      <div className="sectionTitle"><h2>마이</h2><span>Profile</span></div>
      <article className="bigCard">
        <h3>로그인 준비 중</h3>
        <p>다음 단계에서 Supabase Auth를 연결합니다. Guest, Member, Leader 권한 구조로 확장됩니다.</p>
      </article>
      <article className="rowCard"><div className="rowIcon"><Church size={24} /></div><div><h3>목장</h3><p>목장 중심의 공동체 기능이 들어갑니다.</p></div></article>
      <article className="rowCard"><div className="rowIcon"><HandHeart size={24} /></div><div><h3>예배의 드림</h3><p>초기에는 계좌이체 안내 방식으로 제공합니다.</p></div></article>
    </div>
  );
}
      ...
      <main className="shell">
        <header className="topbar">
          <div className="brandrow">
            ...
            <button className="pill"><Menu size={16} /> 메뉴</button>
          </div>
        </header>
